...
def load_args(cfg):
    ...
    ## DiT / BDH ARCHITECTURE
    parser.add_argument("--hidden_size", type=int, default=getattr(cfg, 'hidden_size', 768))
    parser.add_argument("--depth", type=int, default=getattr(cfg, 'depth', 12))
    parser.add_argument("--patch_size", type=int, default=getattr(cfg, 'patch_size', 16))
    parser.add_argument("--bdh_expansion", type=int, default=getattr(cfg, 'bdh_expansion', 4))
